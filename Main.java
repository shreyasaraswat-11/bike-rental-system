        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                if (selectedBike != null) {
                    ...
                    System.out.println(
                            "Bike: " + selectedBike.getBrand() + " "
                                    + selectedBike.getModel());
                ...
                if (bikeToReturn != null) {
                    ...
                    if (customer != null) {
                        ...
                        System.out.println(
                                "Bike returned successfully by "
                                        + customer.getName());

                    } else {
                        System.out.println(
                                "Bike was not rented or rental information is missing.");
                    }

                } else {
                    System.out.println(
                            "Invalid bike ID or bike is not rented.");
                }
